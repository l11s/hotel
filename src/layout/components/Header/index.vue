        ...
        <header v-if="settingsStore.mode === 'pc' && ['head', 'only-head'].includes(settingsStore.menu.menuMode)">
            <div class="header-container">
                <div class="main">
                    ...
                    <!-- 顶部模式 -->
                    <div
                        v-if="settingsStore.menu.menuMode === 'head'"
                        class="nav" :class="{
                    ...
                    >
                        <template v-for="(item, index) in menuStore.allMenus" :key="index">
                            <div v-if="item.children && item.children.length !== 0" class="item-container" :class="{'active': index == menuStore.actived}">
                                <div class="item" @click="switchMenu(index)">
                    ...
                    <!-- 顶部精简模式 -->
                    <el-menu
                        v-else-if="settingsStore.menu.menuMode === 'only-head'" mode="horizontal" :default-active="$route.meta.activeMenu || $route.path" class="el-menu-nav" :class="{
                            [`nav-fill-${settingsStore.menu.menuFillStyle}`]: settingsStore.menu.menuFillStyle !== '',
                            [`nav-active-${settingsStore.menu.menuActiveStyle}`]: settingsStore.menu.menuActiveStyle !== ''
                        }"
                    >
