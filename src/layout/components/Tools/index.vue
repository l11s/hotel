        ...
        <el-dropdown class="user-container" size="default" @command="userCommand">
            ...
            <template #dropdown>
                <el-dropdown-menu class="user-dropdown">
                    <el-dropdown-item v-if="settingsStore.dashboard.enable" command="dashboard">{{ generateI18nTitle('route.dashboard', settingsStore.dashboard.title) }}</el-dropdown-item>
